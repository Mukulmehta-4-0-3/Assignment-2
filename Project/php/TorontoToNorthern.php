            ...
            <div class="main-wrapper">
                ...
                <div class="mainbar">
                    <div class="mainbar-logo">
                        <img src="../images/TorontoToNorthern.png" alt="logo">
                    </div>
                    <p style="margin: 0px 0px 10px 0px"></p>
                    </Users/vipul/Downloads/logo-png.pngdiv class="main-text">
                        <h1>Toronto To Northrun College</h1>
                        ...
                        <?php
                                ...
                                WHERE r.route_name = 'TorontoToNorthrun'";
